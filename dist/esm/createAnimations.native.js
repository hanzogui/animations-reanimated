...
var Animated = getDefaultExport(Animated_);
...
function createWebAnimatedComponent(defaultTag) {
  ...
  var Component = Animated.createAnimatedComponent(/* @__PURE__ */forwardRef(function (propsIn, ref) {
    ...
    var Element = render;
    var transformedProps = (_hooks_usePropsTransform = hooks.usePropsTransform) === null || _hooks_usePropsTransform === void 0 ? void 0 : _hooks_usePropsTransform.call(hooks, render, viewProps, stateRef, false);
...
function createAnimations(animationsConfig) {
  ...
  return {
    ...
    useAnimatedNumberStyle(val, getStyle) {
      ...
      var styleVal = useDerivedValue(function () {
        "worklet";
    ...
    useAnimations(animationProps) {
      ...
      var wasEnteringRef = useRef(isEntering);
      ...
      var animationKey = getEffectiveAnimation(normalized, animationState);
      ...
      var markExitKeyDone = useEvent(function (key3, cycleId, finished) {
      ...
      var isExitingRef = useSharedValue(isExiting);
      var exitCycleIdShared = useSharedValue(exitCycleIdRef.current);
      ...
      var staticTargetsRef = useSharedValue(null);
      var transformTargetsRef = useSharedValue(null);
      var {
        animatedStyles,
        staticStyles
      } = useMemo(function () {
